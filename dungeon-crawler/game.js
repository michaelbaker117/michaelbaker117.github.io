...
function Game() {
  ...
  const ts = isDesk ? 18 : settings.tileSize;
  const viewDX = isDesk ? 16 : 11;
  const viewDY = isDesk ? 11 : 8;
  const mmS = isDesk ? 3 : 2.2;
  const mapRows = [];
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { width: "100vw", height: "100dvh", overflow: "hidden", background: fc.bg, color: "#c8c8d0", fontFamily: "'JetBrains Mono',monospace", position: "relative", userSelect: "none" } }, /* @__PURE__ */ React.createElement("style", null, CSS, `:root{--ac:${fc.accent};}`), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", animation: shaking ? "shake .2s" : inSanc ? "sancP 4s infinite" : "none" } }, /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse" } }, /* @__PURE__ */ React.createElement("tbody", null, mapRows))), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: isDesk ? 12 : 6, left: isDesk ? 12 : 6, zIndex: 10, display: "flex", flexDirection: "column", gap: isDesk ? 4 : 3, width: isDesk ? 220 : 160, pointerEvents: "none" } }, /* @__PURE__ */ React.createElement(Bar, { cur: player.hp, max: player.maxHp, color: "#c33", label: "HP", h: isDesk ? 12 : 8 }), /* @__PURE__ */ React.createElement(Bar, { cur: player.mp, max: player.maxMp, color: "#36c", label: "MP", h: isDesk ? 12 : 8 }), /* @__PURE__ */ React.createElement(Bar, { cur: player.xp, max: xpFor(player.level), color: "#74a", label: "XP", h: isDesk ? 10 : 6 }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: isDesk ? 10 : 8, color: "#888", paddingTop: 1 } }, /* @__PURE__ */ React.createElement("span", null, fc.icon, " F", player.floor, " Lv", player.level), /* @__PURE__ */ React.createElement("span", null, "\u{1F4B0}", player.gold))), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: isDesk ? 12 : 6, right: isDesk ? 12 : 6, zIndex: 20, display: "flex", flexDirection: "column", gap: isDesk ? 5 : 4, alignItems: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setMenu((m) => m ? null : "open"), style: { width: isDesk ? 48 : 42, height: isDesk ? 48 : 42, borderRadius: 10, background: "rgba(14,14,22,.65)", border: `1px solid ${fc.accent}33`, color: menu ? fc.accent : "#888", fontSize: isDesk ? 22 : 18, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", backdropFilter: "blur(4px)", touchAction: "manipulation", position: "relative" } }, menu ? "\u2715" : "\u2630", hasRec && !menu && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 3, right: 3, width: 7, height: 7, borderRadius: "50%", background: "#4c6", animation: "recB 1.5s infinite" } })), menu === "open" && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: isDesk ? 4 : 3, animation: "fadeUp .15s" } }, [["stats", "\u{1F4CA} Stats"], ["inv", "\u{1F392} Inventory"], ["obj", "\u{1F4DC} Quests"], ["settings", "\u2699\uFE0F Settings"]].map(([k, lb]) => /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setMenu(k), style: { padding: isDesk ? "10px 18px" : "8px 14px", borderRadius: 8, background: "rgba(14,14,22,.8)", border: "1px solid #2a2a3a", color: "#aaa", fontSize: isDesk ? 13 : 11, cursor: "pointer", backdropFilter: "blur(6px)", textAlign: "left", fontFamily: "'JetBrains Mono',monospace", touchAction: "manipulation", whiteSpace: "nowrap" } }, lb)))), settings.minimap && !menu && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: isDesk ? 66 : 54, right: isDesk ? 12 : 6, width: MW * mmS + 2, height: MH * mmS + 2, background: "rgba(6,6,12,.55)", border: `1px solid ${fc.wall}33`, borderRadius: 4, overflow: "hidden", zIndex: 8 } }, miniDots), inSanc && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 6, left: "50%", transform: "translateX(-50%)", padding: "3px 12px", background: "rgba(30,60,80,.35)", border: "1px solid #48a3", borderRadius: 8, fontSize: 9, color: "#6bd", zIndex: 10, backdropFilter: "blur(4px)" } }, "\u{1F3D5}\uFE0F SANCTUARY"), !inSanc && bossAlive && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 6, left: "50%", transform: "translateX(-50%)", padding: "3px 10px", background: "rgba(160,20,50,.25)", border: "1px solid #8233", borderRadius: 8, fontSize: 9, color: "#d46", zIndex: 10, backdropFilter: "blur(4px)" } }, player.floor % 10 === 0 ? "\u{1F451} MEGA BOSS" : "\u{1F479} BOSS"), /* @__PURE__ */ React.createElement("div", { ref: logRef, className: "scr", style: { position: "absolute", bottom: isDesk ? 12 : 6, left: isDesk ? 12 : 6, maxWidth: isDesk ? 340 : 240, maxHeight: isDesk ? 56 : 36, overflowY: "auto", zIndex: 8, pointerEvents: "none" } }, eLog.slice(isDesk ? -5 : -3).map((e, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: isDesk ? 10 : 8, color: logCol(e.ty), opacity: i === Math.min(eLog.length - 1, isDesk ? 4 : 2) ? 1 : 0.4, lineHeight: 1.3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", textShadow: "0 1px 4px #000" } }, e.m))), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: isDesk ? 70 : 44, left: isDesk ? 12 : 6, fontSize: isDesk ? 9 : 7, color: "#333", zIndex: 7, pointerEvents: "none", textShadow: "0 1px 3px #000" } }, inSanc ? "Sanctuary" : fc.name), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: isDesk ? 12 : 6, left: "50%", transform: "translateX(-50%)", fontSize: isDesk ? 10 : 8, color: "#555", zIndex: 7, pointerEvents: "none", textShadow: "0 1px 3px #000" } }, "ATK:", computed?.atk, " DEF:", computed?.def, lastSanc > 0 ? ` \xB7 \u2606F${lastSanc}` : ""), !isDesk && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 8, right: 8, zIndex: 15 } }, /* @__PURE__ */ React.createElement(VJoystick, { accent: fc.accent, onDir: move, combatActive: !!combat })), isDesk && !combat && !menu && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 12, right: 12, zIndex: 7, pointerEvents: "none", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, opacity: 0.35 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "28px 28px 28px", gridTemplateRows: "28px 28px", gap: 3 } }, /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(20,20,30,.8)", border: "1px solid #333", borderRadius: 5, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#888", fontFamily: "'JetBrains Mono',monospace" } }, "W"), /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(20,20,30,.8)", border: "1px solid #333", borderRadius: 5, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#888", fontFamily: "'JetBrains Mono',monospace" } }, "A"), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(20,20,30,.8)", border: "1px solid #333", borderRadius: 5, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#888", fontFamily: "'JetBrains Mono',monospace" } }, "S"), /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(20,20,30,.8)", border: "1px solid #333", borderRadius: 5, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "#888", fontFamily: "'JetBrains Mono',monospace" } }, "D")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8, color: "#555", fontFamily: "'JetBrains Mono',monospace" } }, "I = Inv \xB7 Esc = Close")), menu && menu !== "open" && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 50, display: "flex" }, onClick: () => setMenu(null) }, /* @__PURE__ */ React.createElement("div", { className: "scr", style: { width: isDesk ? 400 : 300, maxWidth: isDesk ? "40vw" : "75vw", height: "100%", background: "rgba(12,12,20,.95)", borderRight: `1px solid ${fc.wall}`, overflowY: "auto", padding: isDesk ? "24px 20px" : "18px 14px", backdropFilter: "blur(10px)", animation: "slideRight .2s ease" }, onClick: (e) => e.stopPropagation() }, menu === "stats" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#d4a843", letterSpacing: 2, textAlign: "center", marginBottom: 14, fontFamily: "'Cinzel',serif" } }, player.icon, " ", player.name, " \u2014 Lv ", player.level), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px 14px", fontSize: 11 } }, [["HP", `${player.hp}/${player.maxHp}`, "#c44"], ["MP", `${player.mp}/${player.maxMp}`, "#46c"], ["STR", player.str, "#d94"], ["DEX", player.dex, "#4c8"], ["INT", player.int, "#a8e"], ["DEF", computed?.def, "#8ac"], ["ATK", computed?.atk, "#e84"], ["Gold", player.gold, "#d4a843"], ["Floor", `${player.floor}/100`, fc.accent], ["Tier", getTier(player.floor), "#aaa"], ["Kills", stats.kills, "#777"], ["Respawn", lastSanc > 0 ? `F${lastSanc}` : "None", "#48a"]].map(([l, v, c]) => /* @__PURE__ */ React.createElement("div", { key: l, style: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#555" } }, l), /* @__PURE__ */ React.createElement("span", { style: { color: c } }, v)))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, fontSize: 10, color: "#666" } }, /* @__PURE__ */ React.createElement("div", { style: { color: fc.accent, marginBottom: 4 } }, "Equipped"), /* @__PURE__ */ React.createElement("div", null, "\u{1F5E1}\uFE0F ", player.equipped.weapon ? `${player.equipped.weapon.icon} ${player.equipped.weapon.name} (+${player.equipped.weapon.atk}ATK${player.equipped.weapon.intB ? " +" + player.equipped.weapon.intB + "INT" : ""}${player.equipped.weapon.dexB ? " +" + player.equipped.weapon.dexB + "DEX" : ""})` : "None"), /* @__PURE__ */ React.createElement("div", null, "\u{1F6E1}\uFE0F ", player.equipped.armor ? `${player.equipped.armor.icon} ${player.equipped.armor.name} (+${player.equipped.armor.def}DEF${player.equipped.armor.mpB ? " +" + player.equipped.armor.mpB + "MP" : ""}${player.equipped.armor.dexB ? " +" + player.equipped.armor.dexB + "DEX" : ""})` : "None")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, fontSize: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { color: "#6a7", marginBottom: 4 } }, "Skills"), player.unlocked.map((s) => /* @__PURE__ */ React.createElement("div", { key: s, style: { color: "#999", marginBottom: 2 } }, "\u2726 ", s)), player.skills.filter((s) => !player.unlocked.includes(s)).map((s) => /* @__PURE__ */ React.createElement("div", { key: s, style: { color: "#333", marginBottom: 2 } }, "\u{1F512} ", s)))), menu === "inv" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#d4a843", letterSpacing: 2, textAlign: "center", marginBottom: 8, fontFamily: "'Cinzel',serif" } }, "INVENTORY (", player.inv.length, ")"), hasRec && /* @__PURE__ */ React.createElement("button", { style: { ...btnS, width: "100%", marginBottom: 10, padding: "10px 0", textAlign: "center", borderColor: "#4c66", color: "#4c6", background: "#0a1a0e", fontSize: 11, animation: "recB 2s infinite" }, onClick: equipBest }, "\u2B06\uFE0F EQUIP BEST", /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 8, color: "#385", marginTop: 2 } }, recW ? `\u{1F5E1}\uFE0F${recW.name} ` : "", recA ? `\u{1F6E1}\uFE0F${recA.name}` : "")), player.inv.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { color: "#333", textAlign: "center", padding: 20 } }, "Empty"), player.inv.map((item) => {
    ...
    setScreen("title");
    setMenu(null);
  } }, "\u{1F6AA} Quit"))), /* @__PURE__ */ React.createElement("button", { style: { ...btnS, width: "100%", marginTop: 14, textAlign: "center" }, onClick: () => setMenu(null) }, "Close")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, background: "rgba(0,0,0,.3)" } })), combat && (() => {
    const e = combat.enemy;
    const aura = e.aura || fc.accent;
    return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", background: e.isMega ? `radial-gradient(ellipse at 50% 30%,${aura}22,rgba(8,8,14,.98) 50%)` : e.isBoss ? `radial-gradient(ellipse at center,${aura}15,rgba(8,8,14,.97) 50%)` : "radial-gradient(ellipse at center,#1a0e0e,rgba(8,8,14,.97) 55%)", backdropFilter: "blur(8px)", animation: "fadeUp .15s", "--ba": aura } }, /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 420, padding: "14px 16px", display: "flex", flexDirection: "column", alignItems: "center" } }, e.isMega && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 100, background: `radial-gradient(ellipse at 50% 100%,${aura}18,transparent 70%)`, pointerEvents: "none" } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: e.isMega ? 64 : e.isBoss ? 52 : 40, marginBottom: 2, filter: e.hp <= 0 ? "grayscale(1) brightness(.3)" : "none", transition: "filter .4s", animation: combat.turn === 1 ? e.isMega || e.isBoss ? "bossIn .7s cubic-bezier(.34,1.56,.64,1)" : "fadeUp .3s" : e.isMega ? "megaGlow 3s infinite" : "none" } }, e.icon), e.isMega && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8, color: aura, letterSpacing: 4, fontFamily: "'Cinzel',serif", textShadow: `0 0 10px ${aura}44` } }, "\u26A0\uFE0F MEGA BOSS \u26A0\uFE0F"), e.isBoss && !e.isMega && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8, color: aura, letterSpacing: 3, opacity: 0.8 } }, "FLOOR BOSS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: e.isMega ? aura : e.isBoss ? "#d64" : "#c54", letterSpacing: 2, fontFamily: "'Cinzel',serif", marginTop: 2 } }, e.name), (e.title || e.subtitle) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8, color: "#665", fontStyle: "italic", marginTop: 2 } }, e.title || e.subtitle), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 280, marginTop: 6 } }, /* @__PURE__ */ React.createElement(Bar, { cur: e.hp, max: e.maxHp, color: e.isMega ? aura : "#c44", h: 10 })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8, color: "#444", marginTop: 2, marginBottom: 4 } }, "ATK:", e.atk, " DEF:", e.def, " \xB7 Turn ", combat.turn), /* @__PURE__ */ React.createElement("div", { className: "scr", style: { width: "100%", background: "rgba(8,8,14,.8)", border: "1px solid #1e1e2e", borderRadius: 8, padding: 6, maxHeight: 50, overflowY: "auto", marginBottom: 4 } }, cLog.map((m, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: 9, color: i === cLog.length - 1 ? "#ccc" : "#444", lineHeight: 1.3 } }, m))), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 280, marginBottom: 6 } }, /* @__PURE__ */ React.createElement(Bar, { cur: player.hp, max: player.maxHp, color: "#4a6", label: "YOU", h: 8 })), combat.phase === "player" && /* @__PURE__ */ React.createElement("div", { style: { width: "100%", display: "flex", flexDirection: "column", gap: 5, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, width: "100%", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("button", { style: { ...btnS, flex: 1, maxWidth: 120, padding: "8px 0", fontSize: 12, borderColor: "#c446", color: "#c44" }, onClick: () => pAtk() }, "\u2694\uFE0F Attack"), /* @__PURE__ */ React.createElement("button", { style: { ...btnS, flex: 1, maxWidth: 120, padding: "8px 0", fontSize: 12 }, onClick: flee }, "\u{1F3C3} Flee")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center" } }, player.unlocked.map((s) => /* @__PURE__ */ React.createElement("button", { key: s, style: { ...btnS, fontSize: 8, padding: "4px 7px", borderColor: "#64a5", color: "#97c" }, onClick: () => pAtk(s) }, s))), player.inv.filter((i) => i.type === "consumable").length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center" } }, player.inv.filter((i) => i.type === "consumable").slice(0, 5).map((item) => /* @__PURE__ */ React.createElement("button", { key: item.id, style: { ...btnS, fontSize: 9, padding: "3px 6px" }, onClick: () => useItem(item, true) }, item.icon)))), combat.phase === "enemy" && /* @__PURE__ */ React.createElement("div", { style: { color: "#d84", fontSize: 12, padding: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { animation: "glow .7s infinite" } }, e.icon, " Attacking...")), combat.phase === "won" && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { color: e.isMega ? aura : "#4c6", fontSize: 14, marginBottom: 4, fontFamily: "'Cinzel',serif" } }, e.isMega ? "\u{1F3C6} MEGA BOSS SLAIN!" : e.isBoss ? "\u{1F3C6} BOSS SLAIN!" : "Victory!"), e.isBoss && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9, color: "#888", marginBottom: 3 } }, "\u{1F5E1}\uFE0F\u{1F6E1}\uFE0F Unique F", e.bossFloor || player.floor, " gear!"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#777", marginBottom: 6 } }, "+", e.xp, "xp +", e.gold, "g"), /* @__PURE__ */ React.createElement("button", { style: { ...btnS, padding: "8px 22px", fontSize: 12, borderColor: `${aura}66`, color: aura }, onClick: claimWin }, "Collect [Enter]")), combat.phase === "lost" && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { color: "#c33", fontSize: 13, marginBottom: 6 } }, "Defeated..."), /* @__PURE__ */ React.createElement("button", { style: { ...btnS, padding: "8px 16px" }, onClick: handleDeath }, lastSanc > 0 ? "Respawn" : "Continue"))));
  })());
}
