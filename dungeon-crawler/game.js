...
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@400;700&family=JetBrains+Mono:wght@400;500&display=swap'); *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;} html,body{overscroll-behavior:none;-webkit-overflow-scrolling:touch;touch-action:pan-x pan-y;position:fixed;width:100%;height:100%;height:100dvh;} #root{width:100%;height:100%;height:100dvh;} @keyframes pp{0%,100%{transform:scale(1);filter:drop-shadow(0 0 4px var(--ac,#d4a843))drop-shadow(0 0 10px rgba(212,168,67,.25));}50%{transform:scale(1.12);filter:drop-shadow(0 0 8px var(--ac,#d4a843))drop-shadow(0 0 18px rgba(212,168,67,.5));}} @keyframes fadeUp{from{opacity:0;transform:translateY(10px);}to{opacity:1;transform:translateY(0);}} @keyframes slideUp{from{transform:translateY(100%);}to{transform:translateY(0);}} @keyframes bossIn{0%{transform:scale(.15)rotate(-15deg);opacity:0;filter:blur(16px);}40%{transform:scale(1.3)rotate(3deg);opacity:1;filter:blur(0)drop-shadow(0 0 30px var(--ba,#f44));}70%{transform:scale(.95);}100%{transform:scale(1);filter:drop-shadow(0 0 20px var(--ba,#f44));}} @keyframes megaGlow{0%,100%{filter:drop-shadow(0 0 15px var(--ba,#f44))drop-shadow(0 0 30px var(--ba,#f4444));}50%{filter:drop-shadow(0 0 25px var(--ba,#f44))drop-shadow(0 0 50px var(--ba,#f4466));}} @keyframes shake{0%,100%{transform:translateX(0);}25%{transform:translateX(-4px);}75%{transform:translateX(4px);}} @keyframes glow{0%,100%{opacity:.6;}50%{opacity:1;}} @keyframes sancP{0%,100%{box-shadow:inset 0 0 30px rgba(100,180,240,.05);}50%{box-shadow:inset 0 0 60px rgba(100,180,240,.12);}} @keyframes recB{0%,100%{box-shadow:0 0 4px #4c64;}50%{box-shadow:0 0 10px #4c68;}} .scr::-webkit-scrollbar{width:3px;}.scr::-webkit-scrollbar-thumb{background:#333;border-radius:2px;}`;
const Bar = ({ cur, max, color, label, h = 10 }) => /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, gap: 4, width: “100%” } }, label && /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 8, color: “#666”, minWidth: 18, fontFamily: “‘JetBrains Mono’,monospace” } }, label), /* @**PURE** */ React.createElement(“div”, { style: { flex: 1, height: h, background: “#14141e”, borderRadius: h, overflow: “hidden”, border: “1px solid #222230”, position: “relative” } }, /* @**PURE** */ React.createElement(“div”, { style: { width: `${clamp(cur / max * 100, 0, 100)}%`, height: “100%”, borderRadius: h, background: `linear-gradient(90deg,${color},${color}99)`, transition: “width .3s” } }), /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, inset: 0, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: Math.min(8, h - 2), color: “#fffc”, fontFamily: “‘JetBrains Mono’,monospace”, textShadow: “0 1px 2px #000” } }, cur, “/”, max)));
...
return /* @**PURE** */ React.createElement(
“div”,
{
ref,
...
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: 8, left: “50%”, transform: “translateX(-50%)”, fontSize: 8, color: dir.dy === -1 ? accent : “#333”, transition: “color .1s” } }, “\u25B2”),
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, bottom: 8, left: “50%”, transform: “translateX(-50%)”, fontSize: 8, color: dir.dy === 1 ? accent : “#333”, transition: “color .1s” } }, “\u25BC”),
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, left: 8, top: “50%”, transform: “translateY(-50%)”, fontSize: 8, color: dir.dx === -1 ? accent : “#333”, transition: “color .1s” } }, “\u25C0”),
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, right: 8, top: “50%”, transform: “translateY(-50%)”, fontSize: 8, color: dir.dx === 1 ? accent : “#333”, transition: “color .1s” } }, “\u25B6”),
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: “50%”, left: “50%”, width: 44, height: 44, borderRadius: “50%”, background: `radial-gradient(circle at 40% 36%,${accent}cc,${accent}66,${accent}33)`, border: `1.5px solid ${accent}88`, transform: `translate(calc(-50% + ${knob.x}px),calc(-50% + ${knob.y}px))`, transition: activeRef.current ? “none” : “transform .2s ease-out”, boxShadow: `0 0 ${knob.x || knob.y ? 12 : 6}px ${accent}${knob.x || knob.y ? "66" : "33"},inset 0 -2px 4px rgba(0,0,0,.3)` } }),
/* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: “50%”, left: “50%”, width: 48, height: 48, borderRadius: “50%”, border: `1px dashed ${accent}18`, transform: “translate(-50%,-50%)”, pointerEvents: “none” } })
);
}
function Game() {
...
const fullScreen = (bg, ch) => /* @**PURE** */ React.createElement(“div”, { style: { width: “100vw”, height: “100dvh”, overflow: “hidden”, background: bg, display: “flex”, flexDirection: “column”, alignItems: “center”, justifyContent: “center”, userSelect: “none”, padding: 24, paddingBottom: “max(24px,env(safe-area-inset-bottom))” } }, /* @**PURE** */ React.createElement(“style”, null, CSS), ch);
if (screen === “title”) return fullScreen(“radial-gradient(ellipse at 50% 35%,#1e1a10,#0c0c14 65%)”, /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 32, color: “#d4a843”, textShadow: “0 0 30px #d4a84333”, letterSpacing: 4, textAlign: “center”, lineHeight: 1.2, fontFamily: “‘Cinzel’,serif” } }, “DEPTHS OF”, /* @**PURE** */ React.createElement(“br”, null), “SHADOW”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 10, color: “#555”, letterSpacing: 5, marginTop: 10, fontFamily: “‘JetBrains Mono’,monospace” } }, “A DUNGEON CRAWLER”), /* @**PURE** */ React.createElement(“div”, { style: { width: “60%”, height: 1, background: “linear-gradient(90deg,transparent,#d4a84344,transparent)”, margin: “24px 0” } }), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, gap: 10, width: “100%”, maxWidth: 240 } }, /* @**PURE** */ React.createElement(“button”, { style: { padding: “14px 0”, background: “#1a1508”, border: “1px solid #8b691466”, color: “#d4a843”, borderRadius: 8, fontSize: 14, letterSpacing: 3, fontFamily: “‘Cinzel’,serif”, cursor: “pointer” }, onClick: () => setScreen(“classSelect”) }, “NEW GAME”), save && /* @**PURE** */ React.createElement(“button”, { style: { padding: “11px 0”, background: “#111119”, border: “1px solid #2a2a3a”, color: “#888”, borderRadius: 8, fontSize: 11, fontFamily: “‘JetBrains Mono’,monospace”, cursor: “pointer” }, onClick: () => {
loadGame();
setScreen(“game”);
} }, “CONTINUE \u2014 F”, save.player.floor))));
if (screen === “classSelect”) return /* @**PURE** */ React.createElement(“div”, { style: { width: “100vw”, height: “100dvh”, overflow: “auto”, background: “#0c0c14”, display: “flex”, flexDirection: “column”, alignItems: “center”, padding: “28px 16px”, userSelect: “none” } }, /* @**PURE** */ React.createElement(“style”, null, CSS), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 16, color: “#d4a843”, letterSpacing: 4, marginBottom: 20, fontFamily: “‘Cinzel’,serif” } }, “CHOOSE CLASS”), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, gap: 10, width: “100%”, maxWidth: 340 } }, Object.entries(CLASSES).map(([k, c]) => /* @**PURE** */ React.createElement(“button”, { key: k, onClick: () => startGame(k), style: { padding: 14, textAlign: “left”, display: “flex”, gap: 12, alignItems: “center”, background: “#111119”, border: “1px solid #2a2a3a”, borderRadius: 10, cursor: “pointer”, color: “#c8c8d0”, fontFamily: “‘JetBrains Mono’,monospace” } }, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 30, width: 40, textAlign: “center” } }, c.icon), /* @**PURE** */ React.createElement(“div”, { style: { flex: 1 } }, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 13, color: “#d4a843”, fontFamily: “‘Cinzel’,serif” } }, c.name), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 10, color: “#777”, lineHeight: 1.4 } }, c.desc), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 9, color: “#4a4a5a”, marginTop: 4 } }, “HP:”, c.hp, “ MP:”, c.mp, “ STR:”, c.str, “ DEX:”, c.dex, “ INT:”, c.int))))), /* @**PURE** */ React.createElement(“button”, { style: { marginTop: 18, …btnS }, onClick: () => setScreen(“title”) }, “\u2190 Back”));
if (screen === “respawn”) return fullScreen(“radial-gradient(ellipse at center,#0a1828,#0c0c14 65%)”, /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 40 } }, “\u{1F3D5}\uFE0F”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 20, color: “#66bbee”, letterSpacing: 3, fontFamily: “‘Cinzel’,serif” } }, “SANCTUARY RESPAWN”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 11, color: “#888”, marginTop: 10, textAlign: “center”, lineHeight: 1.8, fontFamily: “‘JetBrains Mono’,monospace” } }, “Fell on Floor “, player?.floor, “.”, /* @**PURE** */ React.createElement(“br”, null), /* @**PURE** */ React.createElement(“span”, { style: { color: “#c84” } }, “-25% gold penalty”)), /* @**PURE** */ React.createElement(“button”, { style: { marginTop: 24, padding: “12px 28px”, background: “#0a1828”, border: “1px solid #6be4”, color: “#6be”, borderRadius: 8, fontSize: 12, cursor: “pointer”, fontFamily: “‘Cinzel’,serif”, letterSpacing: 2 }, onClick: respawn }, “RESPAWN”)));
if (screen === “gameOver”) return fullScreen(“radial-gradient(ellipse at center,#2a0808,#0c0c14 65%)”, /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 44 } }, “\u{1F480}”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 22, color: “#c33”, letterSpacing: 4, fontFamily: “‘Cinzel’,serif” } }, “YOU DIED”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 10, color: “#555”, marginTop: 10, fontFamily: “‘JetBrains Mono’,monospace” } }, “F”, player?.floor, “ \xB7 Lv”, player?.level, “ \xB7 “, stats.kills, “ kills”), /* @**PURE** */ React.createElement(“button”, { style: { marginTop: 24, padding: “12px 28px”, background: “#1a0808”, border: “1px solid #a336”, color: “#c44”, borderRadius: 8, fontSize: 12, cursor: “pointer”, fontFamily: “‘Cinzel’,serif” }, onClick: () => setScreen(“classSelect”) }, “Try Again”), save && /* @**PURE** */ React.createElement(“button”, { style: { marginTop: 8, …btnS }, onClick: () => {
loadGame();
setScreen(“game”);
} }, “Load Save”)));
if (screen === “victory”) return fullScreen(“radial-gradient(ellipse at center,#1a1a08,#0c0c14 65%)”, /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 48 } }, “\u{1F451}”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 22, color: “#d4a843”, letterSpacing: 4, fontFamily: “‘Cinzel’,serif”, marginTop: 8 } }, “VICTORY”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 12, color: “#999”, marginTop: 8 } }, “All 100 floors conquered!”), /* @**PURE** */ React.createElement(“button”, { style: { marginTop: 28, …btnS, borderColor: “#d4a8434”, color: “#d4a843” }, onClick: () => setScreen(“title”) }, “Return”)));
...
if (isP) row.push(/* @**PURE** */ React.createElement(“td”, { key: dx, style: { width: ts + 2, height: ts + 2, textAlign: “center”, verticalAlign: “middle”, padding: 0 } }, /* @**PURE** */ React.createElement(“div”, { style: { width: ts - 2, height: ts - 2, margin: “auto”, borderRadius: “50%”, background: `radial-gradient(circle at 38% 32%,#ffe88a,${fc.accent},#a07020)`, border: “1.5px solid #ffe88a”, animation: “pp 2s ease-in-out infinite”, boxShadow: `0 0 6px ${fc.accent}88` } })));
else if (enemy && vis && inFov) row.push(/* @**PURE** */ React.createElement(“td”, { key: dx, style: { width: ts + 2, height: ts + 2, textAlign: “center”, verticalAlign: “middle”, padding: 0, fontSize: ts - 3, color: “#f44”, textShadow: “0 0 4px #f006” } }, enemy.icon));
else if (isBoss && vis && inFov) row.push(/* @**PURE** */ React.createElement(“td”, { key: dx, style: { width: ts + 2, height: ts + 2, textAlign: “center”, verticalAlign: “middle”, padding: 0, fontSize: ts - 1, color: player.floor % 10 === 0 ? “#f26” : “#f64”, textShadow: `0 0 8px ${player.floor % 10 === 0 ? "#f268" : "#f648"}`, animation: “glow 1.2s infinite” } }, player.floor % 10 === 0 ? “\u{1F451}” : “\u{1F479}”));
else row.push(/* @**PURE** */ React.createElement(“td”, { key: dx, style: { width: ts + 2, height: ts + 2, textAlign: “center”, verticalAlign: “middle”, padding: 0, fontSize: ts, color: s.color, opacity: s.o, textShadow: s.g, lineHeight: 1, fontFamily: “‘JetBrains Mono’,monospace” } }, s.ch));
}
mapRows.push(/* @**PURE** */ React.createElement(“tr”, { key: dy }, row));
}
const mmS = 2.2;
const miniDots = [];
if (settings.minimap) {
...
miniDots.push(/* @**PURE** */ React.createElement(“div”, { key: `${x}-${y}`, style: { position: “absolute”, left: x * mmS, top: y * mmS, width: mmS, height: mmS, background: c } }));
}
}
return /* @**PURE** */ React.createElement(“div”, { style: { width: “100vw”, height: “100dvh”, overflow: “hidden”, background: fc.bg, color: “#c8c8d0”, fontFamily: “‘JetBrains Mono’,monospace”, display: “flex”, flexDirection: “column”, position: “relative”, userSelect: “none”, paddingBottom: “env(safe-area-inset-bottom)” } }, /* @**PURE** */ React.createElement(“style”, null, CSS, `:root{--ac:${fc.accent};}`), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, gap: 8, padding: “max(5px,env(safe-area-inset-top)) 10px 5px”, background: inSanc ? “rgba(10,20,35,.92)” : “rgba(10,10,18,.92)”, borderBottom: `1px solid ${inSanc ? "#2a4a5a55" : fc.wall + "55"}`, flexShrink: 0, zIndex: 10 } }, /* @**PURE** */ React.createElement(“div”, { style: { flex: 1, display: “flex”, flexDirection: “column”, gap: 3 } }, /* @**PURE** */ React.createElement(Bar, { cur: player.hp, max: player.maxHp, color: “#c33”, label: “HP” }), /* @**PURE** */ React.createElement(Bar, { cur: player.mp, max: player.maxMp, color: “#36c”, label: “MP” })), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, alignItems: “flex-end”, gap: 1, minWidth: 55 } }, /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 9, color: inSanc ? “#6be” : fc.accent, fontFamily: “‘Cinzel’,serif” } }, inSanc ? “\u{1F3D5}\uFE0F” : “”, “F”, player.floor), /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 8, color: “#555” } }, “Lv”, player.level, “ \u{1F4B0}”, player.gold))), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 3, padding: “3px 6px”, background: “rgba(14,14,22,.88)”, borderBottom: “1px solid #1a1a28”, flexShrink: 0, zIndex: 10 } }, [[“stats”, “\u{1F4CA}”, “Stats”], [“inv”, “\u{1F392}”, “Inv”], [“obj”, “\u{1F4DC}”, “Quests”], [“settings”, “\u2699\uFE0F”, “Set”]].map(([k, ic, lb]) => /* @**PURE** */ React.createElement(“button”, { key: k, onClick: () => setMenu((m) => m === k ? null : k), style: { …btnS, flex: 1, padding: “5px 4px”, fontSize: 9, background: menu === k ? “#1a1a30” : “transparent”, borderColor: menu === k ? fc.accent + “88” : “#1e1e2e”, color: menu === k ? fc.accent : “#555”, position: “relative” } }, ic, “ “, lb, k === “inv” && hasRec && /* @**PURE** */ React.createElement(“span”, { style: { position: “absolute”, top: 2, right: 4, width: 6, height: 6, borderRadius: “50%”, background: “#4c6”, animation: “recB 1.5s infinite” } })))), /* @**PURE** */ React.createElement(“div”, { style: { flex: 1, display: “flex”, alignItems: “center”, justifyContent: “center”, position: “relative”, overflow: “hidden”, animation: shaking ? “shake .2s” : inSanc ? “sancP 4s infinite” : “none” } }, /* @**PURE** */ React.createElement(“table”, { style: { borderCollapse: “collapse” } }, /* @**PURE** */ React.createElement(“tbody”, null, mapRows)), settings.minimap && /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: 5, right: 5, width: MW * mmS + 2, height: MH * mmS + 2, background: “rgba(6,6,12,.82)”, border: `1px solid ${fc.wall}66`, borderRadius: 4, overflow: “hidden”, zIndex: 5 } }, miniDots), inSanc && /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: 5, left: 5, padding: “3px 10px”, background: “rgba(30,60,80,.3)”, border: “1px solid #48a4”, borderRadius: 8, fontSize: 9, color: “#6bd”, zIndex: 5 } }, “\u{1F3D5}\uFE0F SANCTUARY”), !inSanc && bossAlive && /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: 5, left: 5, padding: “3px 8px”, background: “rgba(160,20,50,.2)”, border: “1px solid #8236”, borderRadius: 6, fontSize: 8, color: “#d46”, zIndex: 5 } }, player.floor % 10 === 0 ? “\u{1F451} MEGA” : “\u{1F479}”, “ BOSS”), /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, bottom: 5, left: 5, fontSize: 8, color: “#333”, zIndex: 5 } }, inSanc ? “Sanctuary” : fc.name)), /* @**PURE** */ React.createElement(“div”, { ref: logRef, className: “scr”, style: { height: 38, overflowY: “auto”, padding: “1px 10px”, background: “rgba(10,10,18,.88)”, borderTop: “1px solid #1a1a28”, flexShrink: 0 } }, eLog.slice(-6).map((e, i) => /* @**PURE** */ React.createElement(“div”, { key: i, style: { fontSize: 9, color: logCol(e.ty), opacity: i === Math.min(eLog.length - 1, 5) ? 1 : 0.55, lineHeight: 1.4, whiteSpace: “nowrap”, overflow: “hidden”, textOverflow: “ellipsis” } }, e.m))), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, padding: “6px 10px 10px”, background: “rgba(10,10,18,.95)”, borderTop: `1px solid ${fc.wall}44`, flexShrink: 0 } }, /* @**PURE** */ React.createElement(VJoystick, { accent: fc.accent, onDir: move, combatActive: !!combat }), /* @**PURE** */ React.createElement(“div”, { style: { flex: 1, display: “flex”, flexDirection: “column”, gap: 4, alignItems: “center”, padding: “0 10px” } }, /* @**PURE** */ React.createElement(“div”, { style: { width: “100%”, maxWidth: 140 } }, /* @**PURE** */ React.createElement(Bar, { cur: player.xp, max: xpFor(player.level), color: “#74a”, label: “XP”, h: 8 })), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 8, color: “#444” } }, “ATK:”, computed?.atk, “ DEF:”, computed?.def), lastSanc > 0 && /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 7, color: “#48a” } }, “Respawn: F”, lastSanc)), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, gap: 4 } }, /* @**PURE** */ React.createElement(“button”, { style: { …btnS, padding: “8px 12px”, position: “relative” }, onClick: () => setMenu(“inv”) }, “\u{1F392}”, hasRec && /* @**PURE** */ React.createElement(“span”, { style: { position: “absolute”, top: 1, right: 1, width: 5, height: 5, borderRadius: “50%”, background: “#4c6” } })), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, padding: “8px 12px” }, onClick: () => setMenu(“stats”) }, “\u{1F4CA}”))), menu && /* @**PURE** */ React.createElement(“div”, { style: { position: “fixed”, inset: 0, zIndex: 50, background: “rgba(6,6,12,.93)”, backdropFilter: “blur(6px)”, display: “flex”, alignItems: “flex-end”, justifyContent: “center”, animation: “fadeUp .15s” }, onClick: () => setMenu(null) }, /* @**PURE** */ React.createElement(“div”, { className: “scr”, style: { background: “#111119”, borderTop: `1px solid ${fc.wall}`, borderRadius: “16px 16px 0 0”, width: “100%”, maxWidth: 440, maxHeight: “78vh”, overflowY: “auto”, padding: “18px 14px 24px”, paddingBottom: “max(24px,env(safe-area-inset-bottom))”, animation: “slideUp .2s” }, onClick: (e) => e.stopPropagation() }, menu === “stats” && /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 15, color: “#d4a843”, letterSpacing: 2, textAlign: “center”, marginBottom: 14, fontFamily: “‘Cinzel’,serif” } }, player.icon, “ “, player.name, “ \u2014 Lv “, player.level), /* @**PURE** */ React.createElement(“div”, { style: { display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: “6px 14px”, fontSize: 11 } }, [[“HP”, `${player.hp}/${player.maxHp}`, “#c44”], [“MP”, `${player.mp}/${player.maxMp}`, “#46c”], [“STR”, player.str, “#d94”], [“DEX”, player.dex, “#4c8”], [“INT”, player.int, “#a8e”], [“DEF”, computed?.def, “#8ac”], [“ATK”, computed?.atk, “#e84”], [“Gold”, player.gold, “#d4a843”], [“Floor”, `${player.floor}/100`, fc.accent], [“Tier”, getTier(player.floor), “#aaa”], [“Kills”, stats.kills, “#777”], [“Respawn”, lastSanc > 0 ? `F${lastSanc}` : “None”, “#48a”]].map(([l, v, c]) => /* @**PURE** */ React.createElement(“div”, { key: l, style: { display: “flex”, justifyContent: “space-between” } }, /* @**PURE** */ React.createElement(“span”, { style: { color: “#555” } }, l), /* @**PURE** */ React.createElement(“span”, { style: { color: c } }, v)))), /* @**PURE** */ React.createElement(“div”, { style: { marginTop: 12, fontSize: 10, color: “#666” } }, /* @**PURE** */ React.createElement(“div”, { style: { color: fc.accent, marginBottom: 4 } }, “Equipped”), /* @**PURE** */ React.createElement(“div”, null, “\u{1F5E1}\uFE0F “, player.equipped.weapon ? `${player.equipped.weapon.icon} ${player.equipped.weapon.name} (+${player.equipped.weapon.atk}ATK${player.equipped.weapon.intB ? " +" + player.equipped.weapon.intB + "INT" : ""}${player.equipped.weapon.dexB ? " +" + player.equipped.weapon.dexB + "DEX" : ""})` : “None”), /* @**PURE** */ React.createElement(“div”, null, “\u{1F6E1}\uFE0F “, player.equipped.armor ? `${player.equipped.armor.icon} ${player.equipped.armor.name} (+${player.equipped.armor.def}DEF${player.equipped.armor.mpB ? " +" + player.equipped.armor.mpB + "MP" : ""}${player.equipped.armor.dexB ? " +" + player.equipped.armor.dexB + "DEX" : ""})` : “None”)), /* @**PURE** */ React.createElement(“div”, { style: { marginTop: 12, fontSize: 10 } }, /* @**PURE** */ React.createElement(“div”, { style: { color: “#6a7”, marginBottom: 4 } }, “Skills”), player.unlocked.map((s) => /* @**PURE** */ React.createElement(“div”, { key: s, style: { color: “#999”, marginBottom: 2 } }, “\u2726 “, s)), player.skills.filter((s) => !player.unlocked.includes(s)).map((s) => /* @**PURE** */ React.createElement(“div”, { key: s, style: { color: “#333”, marginBottom: 2 } }, “\u{1F512} “, s)))), menu === “inv” && /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 15, color: “#d4a843”, letterSpacing: 2, textAlign: “center”, marginBottom: 8, fontFamily: “‘Cinzel’,serif” } }, “INVENTORY (”, player.inv.length, “)”), hasRec && /* @**PURE** */ React.createElement(“button”, { style: { …btnS, width: “100%”, marginBottom: 10, padding: “10px 0”, textAlign: “center”, borderColor: “#4c66”, color: “#4c6”, background: “#0a1a0e”, fontSize: 11, animation: “recB 2s infinite” }, onClick: equipBest }, “\u2B06\uFE0F EQUIP BEST GEAR”, /* @**PURE** */ React.createElement(“span”, { style: { display: “block”, fontSize: 8, color: “#385”, marginTop: 2 } }, recW ? `\u{1F5E1}\uFE0F${recW.name} ` : “”, recA ? `\u{1F6E1}\uFE0F${recA.name}` : “”)), player.inv.length === 0 && /* @**PURE** */ React.createElement(“div”, { style: { color: “#333”, textAlign: “center”, padding: 20 } }, “Empty”), player.inv.map((item) => {
const isR = recW && item.id === recW.id || recA && item.id === recA.id;
return /* @**PURE** */ React.createElement(“div”, { key: item.id, style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, padding: “8px 10px”, background: isR ? “#0c1a0e” : “#0c0c16”, borderRadius: 8, border: `1px solid ${isR ? "#4c63" : "#1e1e2e"}`, marginBottom: 5 } }, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 11, flex: 1 } }, /* @**PURE** */ React.createElement(“span”, null, item.icon, “ “, item.name), item.floor && /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 7, color: “#555”, marginLeft: 3 } }, “F”, item.floor), isR && /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 8, color: “#4c6”, marginLeft: 4 } }, “\u2B06\uFE0F”), /* @**PURE** */ React.createElement(“br”, null), /* @**PURE** */ React.createElement(“span”, { style: { color: “#444”, fontSize: 9 } }, item.type === “weapon” ? `+${item.atk}ATK${item.intB ? ` +${item.intB}INT`: ""}${item.dexB ?` +${item.dexB}DEX` : ""}` : item.type === “armor” ? `+${item.def}DEF${item.mpB ? ` +${item.mpB}MP`: ""}${item.dexB ?` +${item.dexB}DEX` : ""}` : item.effect)), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 4 } }, /* @**PURE** */ React.createElement(“button”, { style: { …btnS, fontSize: 9, padding: “3px 10px”, borderColor: isR ? “#4c64” : “#2a2a3a”, color: isR ? “#4c6” : “#888” }, onClick: () => useItem(item) }, item.type === “consumable” ? “Use” : “Equip”), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, fontSize: 9, padding: “3px 8px”, color: “#d4a843” }, onClick: () => {
const v = Math.floor(item.val / 2);
setPlayer((p) => ({ …p, inv: p.inv.filter((i) => i.id !== item.id), gold: p.gold + v }));
log(`Sold ${v}g`, “info”);
} }, “Sell”)));
})), menu === “obj” && /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 15, color: “#d4a843”, letterSpacing: 2, textAlign: “center”, marginBottom: 14, fontFamily: “‘Cinzel’,serif” } }, “OBJECTIVES”), OBJ.map((o) => {
const done = o.c({ …stats, floor: player.floor, level: player.level });
return /* @**PURE** */ React.createElement(“div”, { key: o.id, style: { display: “flex”, alignItems: “center”, gap: 8, padding: “5px 0”, fontSize: 11, color: done ? “#4c6” : “#555” } }, /* @**PURE** */ React.createElement(“span”, { style: { fontSize: 13 } }, done ? “\u2705” : “\u2B1C”), /* @**PURE** */ React.createElement(“span”, { style: { textDecoration: done ? “line-through” : “none” } }, o.text));
})), menu === “settings” && /* @**PURE** */ React.createElement(React.Fragment, null, /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 15, color: “#d4a843”, letterSpacing: 2, textAlign: “center”, marginBottom: 14, fontFamily: “‘Cinzel’,serif” } }, “SETTINGS”), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, gap: 12, fontSize: 11 } }, /* @**PURE** */ React.createElement(“div”, null, /* @**PURE** */ React.createElement(“span”, { style: { color: “#666” } }, “Difficulty”), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 6, marginTop: 6 } }, [“easy”, “normal”, “hard”].map((d) => /* @**PURE** */ React.createElement(“button”, { key: d, style: { …btnS, flex: 1, borderColor: settings.difficulty === d ? fc.accent + “88” : “#2a2a3a”, color: settings.difficulty === d ? fc.accent : “#555”, textTransform: “uppercase” }, onClick: () => setSettings((s) => ({ …s, difficulty: d })) }, d)))), /* @**PURE** */ React.createElement(“div”, null, /* @**PURE** */ React.createElement(“span”, { style: { color: “#666” } }, “Tile Size”), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 6, marginTop: 6 } }, [{ l: “S”, v: 11 }, { l: “M”, v: 13 }, { l: “L”, v: 15 }].map((s) => /* @**PURE** */ React.createElement(“button”, { key: s.l, style: { …btnS, flex: 1, borderColor: settings.tileSize === s.v ? fc.accent + “88” : “#2a2a3a”, color: settings.tileSize === s.v ? fc.accent : “#555” }, onClick: () => setSettings((st) => ({ …st, tileSize: s.v })) }, s.l)))), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, justifyContent: “space-between” } }, /* @**PURE** */ React.createElement(“span”, { style: { color: “#666” } }, “Minimap”), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, borderColor: settings.minimap ? “#4a66” : “#2a2a3a”, color: settings.minimap ? “#4a6” : “#555” }, onClick: () => setSettings((s) => ({ …s, minimap: !s.minimap })) }, settings.minimap ? “ON” : “OFF”)), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 6, marginTop: 6 } }, /* @**PURE** */ React.createElement(“button”, { style: { …btnS, flex: 1, borderColor: “#46c6”, color: “#58c” }, onClick: saveGame }, “\u{1F4BE} Save”), save && /* @**PURE** */ React.createElement(“button”, { style: { …btnS, flex: 1, borderColor: “#4a66”, color: “#4a6” }, onClick: loadGame }, “\u{1F4C2} Load”)), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, borderColor: “#c336”, color: “#c44”, marginTop: 4 }, onClick: () => {
setScreen(“title”);
setMenu(null);
} }, “\u{1F6AA} Quit”))), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, width: “100%”, marginTop: 14, textAlign: “center” }, onClick: () => setMenu(null) }, “Close”))), combat && (() => {
const e = combat.enemy;
const aura = e.aura || fc.accent;
return /* @**PURE** */ React.createElement(“div”, { style: { position: “fixed”, inset: 0, zIndex: 60, display: “flex”, alignItems: “center”, justifyContent: “center”, background: e.isMega ? `radial-gradient(ellipse at 50% 30%,${aura}22,rgba(8,8,14,.98) 50%)` : e.isBoss ? `radial-gradient(ellipse at center,${aura}15,rgba(8,8,14,.97) 50%)` : “radial-gradient(ellipse at center,#1a0e0e,rgba(8,8,14,.97) 55%)”, backdropFilter: “blur(8px)”, animation: “fadeUp .15s”, “–ba”: aura } }, /* @**PURE** */ React.createElement(“div”, { style: { width: “100%”, maxWidth: 380, padding: “20px 16px”, display: “flex”, flexDirection: “column”, alignItems: “center” } }, e.isMega && /* @**PURE** */ React.createElement(“div”, { style: { position: “absolute”, top: 0, left: 0, right: 0, height: 120, background: `radial-gradient(ellipse at 50% 100%,${aura}18,transparent 70%)`, pointerEvents: “none” } }), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: e.isMega ? 80 : e.isBoss ? 64 : 48, marginBottom: 4, filter: e.hp <= 0 ? “grayscale(1) brightness(.3)” : “none”, transition: “filter .4s”, animation: combat.turn === 1 ? e.isMega || e.isBoss ? “bossIn .7s cubic-bezier(.34,1.56,.64,1)” : “fadeUp .3s” : e.isMega ? “megaGlow 3s infinite” : “none” } }, e.icon), e.isMega && /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 9, color: aura, letterSpacing: 4, fontFamily: “‘Cinzel’,serif”, textShadow: `0 0 10px ${aura}44` } }, “\u26A0\uFE0F MEGA BOSS \u26A0\uFE0F”), e.isBoss && !e.isMega && /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 8, color: aura, letterSpacing: 3, opacity: 0.8 } }, “FLOOR BOSS”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 16, color: e.isMega ? aura : e.isBoss ? “#d64” : “#c54”, letterSpacing: 2, fontFamily: “‘Cinzel’,serif”, marginTop: 2 } }, e.name), (e.title || e.subtitle) && /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 8, color: “#665”, fontStyle: “italic”, marginTop: 3 } }, e.title || e.subtitle), /* @**PURE** */ React.createElement(“div”, { style: { width: “100%”, maxWidth: 260, marginTop: 10 } }, /* @**PURE** */ React.createElement(Bar, { cur: e.hp, max: e.maxHp, color: e.isMega ? aura : “#c44”, h: 14 })), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 8, color: “#444”, marginTop: 4, marginBottom: 8 } }, “ATK:”, e.atk, “ DEF:”, e.def, “ \xB7 Turn “, combat.turn), /* @**PURE** */ React.createElement(“div”, { className: “scr”, style: { width: “100%”, background: “rgba(8,8,14,.8)”, border: “1px solid #1e1e2e”, borderRadius: 8, padding: 8, maxHeight: 70, overflowY: “auto”, marginBottom: 8 } }, cLog.map((m, i) => /* @**PURE** */ React.createElement(“div”, { key: i, style: { fontSize: 9, color: i === cLog.length - 1 ? “#ccc” : “#444”, lineHeight: 1.4 } }, m))), /* @**PURE** */ React.createElement(“div”, { style: { width: “100%”, maxWidth: 260, marginBottom: 10 } }, /* @**PURE** */ React.createElement(Bar, { cur: player.hp, max: player.maxHp, color: “#4a6”, label: “YOU”, h: 10 })), combat.phase === “player” && /* @**PURE** */ React.createElement(“div”, { style: { width: “100%”, display: “flex”, flexDirection: “column”, gap: 8, alignItems: “center” } }, /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 8, width: “100%”, justifyContent: “center” } }, /* @**PURE** */ React.createElement(“button”, { style: { …btnS, flex: 1, maxWidth: 130, padding: “10px 0”, fontSize: 12, borderColor: “#c446”, color: “#c44” }, onClick: () => pAtk() }, “\u2694\uFE0F Attack”), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, flex: 1, maxWidth: 130, padding: “10px 0”, fontSize: 12 }, onClick: flee }, “\u{1F3C3} Flee”)), /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 4, flexWrap: “wrap”, justifyContent: “center” } }, player.unlocked.map((s) => /* @**PURE** */ React.createElement(“button”, { key: s, style: { …btnS, fontSize: 8, padding: “5px 9px”, borderColor: “#64a5”, color: “#97c” }, onClick: () => pAtk(s) }, s))), player.inv.filter((i) => i.type === “consumable”).length > 0 && /* @**PURE** */ React.createElement(“div”, { style: { display: “flex”, gap: 4, flexWrap: “wrap”, justifyContent: “center” } }, player.inv.filter((i) => i.type === “consumable”).slice(0, 5).map((item) => /* @**PURE** */ React.createElement(“button”, { key: item.id, style: { …btnS, fontSize: 9, padding: “4px 8px” }, onClick: () => useItem(item, true) }, item.icon)))), combat.phase === “enemy” && /* @**PURE** */ React.createElement(“div”, { style: { color: “#d84”, fontSize: 12, padding: 10 } }, /* @**PURE** */ React.createElement(“span”, { style: { animation: “glow .7s infinite” } }, e.icon, “ Attacking…”)), combat.phase === “won” && /* @**PURE** */ React.createElement(“div”, { style: { textAlign: “center” } }, /* @**PURE** */ React.createElement(“div”, { style: { color: e.isMega ? aura : “#4c6”, fontSize: 15, marginBottom: 6, fontFamily: “‘Cinzel’,serif” } }, e.isMega ? “\u{1F3C6} MEGA BOSS SLAIN!” : e.isBoss ? “\u{1F3C6} BOSS SLAIN!” : “Victory!”), e.isBoss && /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 9, color: “#888”, marginBottom: 4 } }, “\u{1F5E1}\uFE0F\u{1F6E1}\uFE0F Unique F”, e.bossFloor || player.floor, “ gear!”), /* @**PURE** */ React.createElement(“div”, { style: { fontSize: 10, color: “#777”, marginBottom: 10 } }, “+”, e.xp, “xp +”, e.gold, “g”), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, padding: “10px 28px”, fontSize: 12, borderColor: `${aura}66`, color: aura }, onClick: claimWin }, “Collect [Enter]”)), combat.phase === “lost” && /* @**PURE** */ React.createElement(“div”, { style: { textAlign: “center” } }, /* @**PURE** */ React.createElement(“div”, { style: { color: “#c33”, fontSize: 14, marginBottom: 10 } }, “Defeated…”), /* @**PURE** */ React.createElement(“button”, { style: { …btnS, padding: “10px 20px” }, onClick: handleDeath }, lastSanc > 0 ? “Respawn” : “Continue”))));
})());
}
